...
const Schedule = () => {
    ...
    piketGroup = [
        ["Adly", "Nanda", "Gus Adi", "Yoga Adi", "Nindia", "Wilan", "Gita"],
        ["Amel", "Dika", "Messi", "Ardi", "Wahyu", "Devika", "Indah"],
        ["Agung", "Kanaya", "Teduh", "Yoga Surya", "Diviana", "Riska", "Kiran"],
        ["Wikan", "Noval", "Dio", "Dinda", "Adis", "Cahaya", "Rendra"],
        ["Diana", "Delvin", "Mandala", "Ayu sri", "Febri", "Cyntia", "Viola"],
    ]
